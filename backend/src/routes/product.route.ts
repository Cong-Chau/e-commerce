...
import { createProduct, updateProductImages, getMyProducts } from '../controllers/product.controller';
import { authenticate, authorize } from '../middlewares/auth.middleware';
import { validate, validateQuery } from '../middlewares/validate.middleware';
import { CreateProductDto, UpdateProductImagesDto, MyProductsQueryDto } from '../dtos/product.dto';
